...
```bash
curl -sL https://raw.githubusercontent.com/Gera-Garza/termux-lab/main/install.sh | bash
```
**Or using wget:**
```bash
wget -O - https://raw.githubusercontent.com/Gera-Garza/termux-lab/main/install.sh | bash
```
---
## ✨ Features
| Feature | Description |
